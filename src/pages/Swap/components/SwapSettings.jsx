...
const SwapSettings = ({ isOpen, onClose, slippage, setSlippage }) => {
  ...
  return (
    <div
      ref={dropdownRef}
      className="absolute right-0 top-10 w-72 max-w-[calc(100vw-3rem)] p-4 bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl shadow-xl z-20"
    >
      <div className="flex justify-between items-center">
        <span className="text-lg font-semibold leading-none">Settings</span>
        <button onClick={onClose} className="p-1 rounded-xl hover:bg-white/10">
