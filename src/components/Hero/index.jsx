      ...
      <div className='min-h-screen justify-start items-center flex'>
        <div className='text-center absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2'>
          ...
          <div className='inline-block no-underline mt-11 md:mt-6 animate-fadeInUpDelay'>
            <button className='w-56 h-12 bg-white text-black rounded-xl m-2 text-lg font-semibold cursor-pointer transition-transform hover:scale-105 active:scale-95 duration-300'>User Guides</button>
            <button className='w-56 h-12 bg-black text-white rounded-xl m-2 text-lg font-semibold cursor-pointer transition-transform hover:scale-105 active:scale-95 duration-300'>Developer Docs</button>
          </div>
        </div>
      </div>
    </div>
